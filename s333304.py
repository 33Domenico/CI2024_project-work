...
def f8(x: np.ndarray) -> np.ndarray: 
    return ((((x[4] * (((2504.6762441338033 + 2327.72864884224) / (2037.7808318240168 * x[4])) - x[4])) / safe_sqrt((((x[5] * safe_log(x[5])) - x[5]) * ((x[5] * (x[5] / -84.66141760491249)) * (-16499.249450017396 * (x[5] / -87.31736297425388)))))) + ((safe_sqrt(x[5]) * x[5]) - (((x[5] * safe_log((2504.6762441338033 + 2327.72864884224))) / (-87.31736297425388 * (x[5] * x[5]))) + ((x[3] / -89.11503286199647) + ((x[3] / -89.11503286199647) + ((x[3] / -89.11503286199647) + x[5])))))) * (safe_sqrt(x[5]) * safe_sqrt((((x[5] * safe_log(x[5])) - x[5]) * (-16499.249450017396 * (x[5] * x[5]))))))